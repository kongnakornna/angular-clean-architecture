...
@Component({
  selector: 'app-tabler-sidebar',
  standalone: true,
  template: `
    <aside class="navbar navbar-vertical navbar-expand-lg"
           [class.navbar-end]="end"
          ...
          <ul class="navbar-nav pt-lg-3">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="/tabler">Default</a>
                <a class="dropdown-item" href="/tabler/dashboard-crypto">Crypto</a>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/tabler/blank">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-1"><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /></svg>
                </span>
                <span class="nav-link-title">Blank page</span>
              </a>
            </li>
          </ul>
        </div>
