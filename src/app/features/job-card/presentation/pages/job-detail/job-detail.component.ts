...
<div class="page-header d-print-none">
  <div class="row align-items-center">
    <div class="col">
      <h2 class="page-title">รายละเอียดงาน</h2>
      <div class="text-secondary mt-1">{{ job.jobNumber }}</div>
    </div>
    <div class="col-auto ms-auto d-print-none">
      <a routerLink="/jobs" class="btn btn-outline-secondary me-2">กลับ</a>
      <a routerLink="/jobs/1/edit" class="btn btn-primary">แก้ไข</a>
    </div>
  </div>
</div>
<div class="row g-3">
  <div class="col-md-8">
      ...
      <div class="card-body">
        <div class="datagrid">
          <div class="datagrid-item">
            <div class="datagrid-title">เลขงาน</div>
          ...
          <div class="datagrid-item">
            <div class="datagrid-title">อุปกรณ์</div>
          ...
          <div class="datagrid-item">
            <div class="datagrid-title">ความสำคัญ</div>
            <div class="datagrid-content">
              <span class="badge bg-red">{{ job.priority }}</span>
            </div>
          </div>
          <div class="datagrid-item">
            <div class="datagrid-title">ผู้รับผิดชอบ</div>
    ...
    <div class="card mt-3">
      <div class="card-header"><h3 class="card-title">ไฟล์แนบ</h3></div>
      <div class="card-body">
        ...
        <div *ngIf="attachments.length === 0" class="text-secondary py-2">ไม่มีไฟล์แนบ</div>
      </div>
    </div>
  </div>
  <div class="col-md-4">
    <div class="card">
      <div class="card-header"><h3 class="card-title">ไทม์ไลน์</h3></div>
      <div class="card-body">
