        ...
        "/mqtt/gettopicdata": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "MQTT timeout or internal error",
                        "schema": {
                            "$ref": "#/definitions/icmongolang_internal_modules_mqtt_delivery_http.errResponse"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/presenter.PublishRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/presenter.PublishResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
